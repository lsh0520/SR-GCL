...
from model import GraphTrans, GraphTrans_pred
...
def main():
    ...
    parser.add_argument('--input_model_file', type=str, default="models_graphtrans/graphtrans-sr-gcl.pth",
    ...
    #set up model
    model = GraphTrans_pred(args, num_tasks)
    model.to(device)
    ...
    for epoch in range(1, epoch_num+1):
        ...
        print("train: %.4f val: %.4f test: %.4f | best val: %.4f test: %.4f" %
              (train_acc, val_acc, test_acc, best_val_acc, best_test_acc))
